...
export const ProjectThumbnail = ({ thumbImage, projectIndex }: ProjectThumbnailProps) => {
  ...
  return (
    <li onClick={toogleActive} className="relative w-full modal:h-20 h-16 flex justify-center items-center border-t-[3px] last:border-b-[3px] border-white box-content">
      <div className={`absolute z-10 w-full modal:h-20 h-16 bg-[rgba(0,0,0,.6)] ${isActive && 'hidden'}`}></div>
