      ...
      >
        <Link
          href={`${project === index.toString()
            ? '?menu=true'
            : `?project=${index}`}#${projectName.replaceAll(' ', '')}`
          }
        ...
        >
          ...
          <div className={`${project === index.toString() ? "hidden tablet:block size-[26px] laptop:size-10 absolute border-b-[3px] border-l-[3px] rounded-sm rotate-45 bg-dark-green -right-[43px] laptop:-right-[64px] cursor-default" : ''} ${project && ' animate-sizeAnimation'}`}></div>
