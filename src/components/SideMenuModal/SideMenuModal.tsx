...
export const SideMenuModal = () => {
  return (
    <div className="absolute w-screen h-screen flex items-center z-20 backdrop-blur-sm">
      <div className="absolute z-30 w-[70%] min-h-[80%] left-[276px] grid grid-cols-2 grid-rows-2 px-8 border-3 rounded bg-[radial-gradient(circle_at_80%_20%,_var(--tw-gradient-stops))] from-green via-dark-green via-50% to-dark-green">
